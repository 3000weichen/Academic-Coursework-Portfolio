...
class differenceWindyShortEnvironment(WindyShortcutEnvironment):
    def __init__(self, seed=None):
        super().__init__(seed)
        self.r = 12
        self.c = 12
    ...
    def step(self, action):
        ...
        if self.rng.random()<self.windProbs:
            # Wind!
            if self.y < self.r-1:
                self.y += 1
        ...
        if self.s[self.y, self.x]=='G': # Goal reached
            ...
            return -1
                ...
                return -100
        return -1
    def set_wind_probs(self, wind_probs):
        self.windProbs = wind_probs
